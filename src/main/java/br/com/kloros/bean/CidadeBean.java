...
public class CidadeBean implements Serializable {
	...
	public void editar(ActionEvent evento) {
		...
		try {
			...
			Messages.addFlashGlobalError("Ocorreu um erro ao selecionar uma nova cidade");
			erro.printStackTrace();
		}
	}
	...
	public void excluir(ActionEvent evento) {
		...
		try {
			...
			cidades = cidadeDAO.listar(); // Atualizar listagem

		} catch (RuntimeException erro) {
			Messages.addGlobalError("Ocorreu um erro em excluir : " + cidade.getNome());
			erro.printStackTrace();
		}

		Messages.addGlobalInfo("Excluido: " + cidade.getNome());
